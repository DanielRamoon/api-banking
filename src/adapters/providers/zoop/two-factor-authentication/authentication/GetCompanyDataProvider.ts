...
type GetCompanyDataProps = {
  xAuthToken: string
}

export class GetCompanyDataProvider implements ApplicationProvider {
  ...
  > {
    ...
    const _endpoint = `${this.applicationHttpRequest.getBaseURL()}/company/applications`
