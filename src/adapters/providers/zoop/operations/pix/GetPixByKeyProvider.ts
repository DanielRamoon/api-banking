...
export class GetPixByKeyProvider implements ApplicationProvider {
  ...
  > {
    ...
    const _partialUrl = `holders/${holderId}/accounts/${accountId}/entries/keys/${value}`
