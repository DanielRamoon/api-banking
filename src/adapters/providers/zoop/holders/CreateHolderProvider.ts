...
export class CreateHolderProvider implements ApplicationProvider {
  ...
  async execute({
    ...
    pep,
    mothersName
  }: CreateHolderProps): Promise<object | ApplicationError> {
    ...
    const _endpoint = `${this.applicationHttpRequest.getBaseURL()}/holders`
